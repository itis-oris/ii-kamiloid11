...
/**
 * При старте проверяет, не висит ли уже какой-то процесс на нашем порту, и пытается его убить.
 * Полезно во время разработки: упало в IDEA, не дочистило сокет — следующий запуск падал
 * с BindException. это костыль, переделать когда будет время
 */
@Slf4j

...
/**
 * Контроллер страниц профиля: просмотр публичного профиля по username
 * и форма редактирования собственного профиля.
 */
@Controller
...
public class ProfileController {
    ...
    /** Публичная страница профиля: выводит пользователя, его объявления и отзывы. */
    @GetMapping("/{username}")

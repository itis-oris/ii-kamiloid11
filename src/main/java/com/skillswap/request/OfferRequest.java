...
/**
 * Тело REST-запроса на создание/обновление объявления.
 * Дублирует {@link com.skillswap.form.OfferForm}, но с Swagger-схемой —
 * чтобы документация в /swagger-ui.html отражала контракт API.
 */
@Getter
@Setter
